...
export function toMetalLedgerPayload(data: MetalLedgerFormData): Record<string, unknown> {
  const base: Record<string, unknown> = {
    ...
    issue_fine_deficit: data.issue_fine_deficit != null ? parseFloat(String(data.issue_fine_deficit)) : 0,
...
export function toInitialMetalLedgerData(entity: Record<string, unknown>): Partial<MetalLedgerFormData> {
  return {
    ...
    issue_fine_deficit: entity.issue_fine_deficit != null ? String(entity.issue_fine_deficit) : '0',
