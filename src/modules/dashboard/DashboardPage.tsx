    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        {[
          ...
          { title: 'Equipment Uptime', value: '96.8%', info: 'Operational status', color: 'purple' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className={`lg:col-span-2 p-5 sm:p-6 rounded-xl ${
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={line.name} className={`p-4 rounded-lg ${
                ...
                <div className={`w-full h-2 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
                  <div 
                    className={`h-2 rounded-full transition-all ${
                      ...
                      line.color === 'yellow' ? 'bg-yellow-500' : 'bg-red-500'
                    }`}
        ...
        {/* Recent Activity */}
        <div className={`p-5 sm:p-6 rounded-xl ${
          isDarkMode 
            ? 'bg-gray-800/50 border border-gray-700' 
            : 'bg-white border border-gray-200 shadow-sm'
        }`}>
