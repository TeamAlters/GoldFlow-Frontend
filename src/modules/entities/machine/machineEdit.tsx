...
import { toInitialMachineData, toMachinePayload } from './machineCreate';
...
export default function MachineEditPage() {
  ...
  const handleSubmit = useCallback(
    async (formData: StaticMachineFormData) => {
      ...
      try {
        await updateEntity(ENTITY_NAME, decodeURIComponent(id), toMachinePayload(formData));
  ...
  const breadcrumbLabel = initialData?.machine_name ?? 'Edit Machine';
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="flex items-center justify-end gap-3 pt-6 mt-6">
          ...
          >
            {submitLoading ? 'Saving...' : 'Update Machine'}
          </button>
        </div>
      </form>
    </div>
