...
import { toInitialThiknessData, toThiknessPayload } from './thiknessCreate';

const ENTITY_NAME = 'thikness';

export default function ThiknessEditPage() {
  ...
  const handleSubmit = useCallback(
    async (formData: StaticThiknessFormData) => {
      ...
      try {
        await updateEntity(ENTITY_NAME, decodeURIComponent(id), toThiknessPayload(formData));
