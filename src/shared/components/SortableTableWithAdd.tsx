...
export default function SortableTableWithAdd({
  ...
  const inputClass = `w-full max-w-[200px] px-3 py-2 text-sm rounded-lg border transition-all focus:outline-none focus:ring-2 focus:ring-inset ${
    isDarkMode
        ...
        <table className="min-w-full">
          <thead>
            <tr>
              ...
              {!readOnly && <th className={`${thClass} w-20 text-right`}>Actions</th>}
            </tr>
          </thead>
            ...
            {rows.map((row, index) => (
              <tr
                ...
                className={`transition-all duration-200 ease-out ${
                  draggedIndex === index
                    ? isDarkMode
                      ? 'relative z-30 opacity-90 shadow-[0_12px_32px_-8px_rgba(0,0,0,0.5)] border-2 border-dashed border-blue-400/70 bg-gray-700/90'
                      : 'relative z-30 opacity-90 shadow-[0_12px_32px_-8px_rgba(0,0,0,0.2)] border-2 border-dashed border-blue-500/60 bg-white/95'
                    : isDarkMode
                      ? index % 2 === 0
                        ? 'bg-gray-800/50'
                        : 'bg-gray-800/30'
              ...
              >
                ...
                <td className={`${tdClass} max-w-[200px] overflow-visible`}>
                  {readOnly ? (
                    ...
                    <div className="max-w-[200px] min-w-0">
                      <select
                        ...
                        onChange={(e) => handleRowChange(index, 'department_id', e.target.value)}
